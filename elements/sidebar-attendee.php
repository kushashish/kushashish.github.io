    ...
    <div class="tabs-wrapper">
        ...
        <div class="tabs" id="tabsWrapper">
            ...
            <div class="tab" id="videoBox">
                <div class="video-scroller video-scroller-attendee">
                ...
                <div class="other-video-box other-video-box-attendee">
                    <img src="/img/video2.jpg" alt="video">
                </div>
                <div class="d-md-none text-center video-controll">
                    <button class="btn-icons btn-audio-filled" data-model="toggle"></button>
                    <button class="btn-icons btn-video-filled" data-model="toggle"></button>
                </div>
            </div>
        </div>
    </div>
